...
import api from '../api';
import { LayoutDashboard, Wallet, TrendingUp, IndianRupee, Clock, LogOut, Menu, X, Play, User, ArrowRightLeft, CreditCard, Target } from 'lucide-react';
...
const Layout = () => {
  ...
  const navItems = [
    ...
    { path: '/dashboard/goals', label: 'Financial Goals', icon: <Target size={20} /> },
  ];
